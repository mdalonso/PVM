...
/** ESTE SCRIPT TIENE IMPLEMENTADO PASOS 1-9 + RETO 2 EN FORMA DE SCRIPT MONOLÍTICO: 
 * Se modulariza en los siguientes scripts atómicos:
 * - PlayerMovement: Movimiento del enemigo.
 * - PlayerAiming: Manejo de la mira.
 * - PlayerShooting: Manejo del disparo.
 * - PlayerHealth: Manejo de la vida
 * - PlayerCollisions: Manejo de las colisiones
 */
...
public class Player : MonoBehaviour
{
   ...
   // [SerializeField] Camera camera;
    ...
    //Se define como una variable de tipo Transform porque sólo vamos a utilizar las propiedades
    //de ese componente
    ...
    //Campo que define la "vida" del player.
    ...
    //Reto 2: Conseguir que el player reciba daño cuando es alcanzado por un Enemigo.
    void TakeDamage()
    {
        _health--;
        if (_health <= 0)
